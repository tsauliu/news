#!/usr/bin/env python3
# Generate Chinese email in MHT format following exact template
...
# Convert markdown to simple HTML bullets
...
# Generate simple HTML body following template format
...
# Generate MHT
output_file = f'data/7_emails/{test_date}_email_simple.mht'
create_mht(html_body, output_file)

print(f"✅ Simple MHT Email generated: {output_file}")
